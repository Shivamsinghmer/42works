export const SERVICES_DATA = {
  "ai-audit": {
    ...
    title: "Uncover Risk.\nUnlock Potential.",
    subtitle:
      "We conduct deep technical audits of your AI systems â€” LLM pipelines, agentic frameworks, model governance, and data infrastructure â€” surfacing hidden risks before they cost you.",
    heroImage:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1200&fit=crop&q=80",
    cta: { primary: "Get an Audit", secondary: "See How It Works" },
    capabilities: [
      {
        title: "LLM Pipeline Audit",
        desc: "End-to-end review of your large language model pipelines â€” from data ingestion and pre-processing to inference and output.",
        icon: "brain",
      },
      {
        title: "AI Agent Security",
        desc: "Security assessment of agentic systems, tool use, memory management, and inter-agent communication channels.",
        icon: "shield",
      },
      {
        title: "Model Governance",
        desc: "Compliance and governance frameworks for responsible AI deployment aligned with EU AI Act and enterprise standards.",
        icon: "check",
      },
      {
        title: "Data Privacy Review",
        desc: "Audit of training data, PII handling, data lineage, and adherence to GDPR, CCPA and industry regulations.",
        icon: "lock",
      },
      {
        title: "Performance & Cost",
        desc: "Benchmarking inference performance, latency, cost efficiency, and infrastructure scalability.",
        icon: "chart",
      },
      {
        title: "RAG Systems",
        desc: "Evaluation of retrieval-augmented generation pipelines for accuracy, hallucination risk, and security boundaries.",
        icon: "search",
      },
    ],
    process: [
      { step: "01", title: "Discovery", desc: "We map your AI landscape â€” models, pipelines, data flows, and third-party dependencies." },
      { step: "02", title: "Technical Deep-Dive", desc: "Our engineers audit code, configs, prompts, and infrastructure layer by layer." },
      { step: "03", title: "Risk Assessment", desc: "We produce a prioritized risk matrix with severity scores and business impact ratings." },
      { step: "04", title: "Remediation Roadmap", desc: "A clear action plan with timelines, ownership assignments, and estimated effort." },
      { step: "05", title: "Report & Debrief", desc: "Executive summary plus full technical report, delivered with a live debrief session." },
    ],
    useCases: [
      { title: "FinTech AI Compliance", tag: "Finance", desc: "Auditing AI credit scoring and fraud detection systems for regulatory compliance.", image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&fit=crop" },
      { title: "Healthcare LLM Safety", tag: "Healthcare", desc: "Validating clinical AI assistants for patient safety, PII, and HIPAA compliance.", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&fit=crop" },
      { title: "Enterprise AI Governance", tag: "Enterprise", desc: "Establishing model governance frameworks for large-scale enterprise AI rollouts.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&fit=crop" },
    ],
    stats: [
      { value: "120+", label: "AI Audits Completed" },
      { value: "2 wk", label: "Avg. Turnaround" },
      { value: "98%", label: "Client Satisfaction" },
      { value: "40+", label: "Risk Categories Covered" },
    ],
  },
